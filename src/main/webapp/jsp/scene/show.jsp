    ...
    <body>
        ...
        <main class="container">
            ...
            <c:if test="${blockDeleted}">
                <div id="undo-notification" style="padding: 1rem; background: var(--pico-primary-background); border-radius: var(--pico-border-radius);" role="alert">
            ...
            <div >
                <h1 style="text-transform: uppercase;">${viewModel.name} <small><a href="${pageContext.request.contextPath}/scene/edit?id=${viewModel.id}" role="button" class="secondary" role="button">edit</a> <a href="${pageContext.request.contextPath}/scene/delete?id=${viewModel.id}" role="button" class="secondary" role="button">delete</a></small></h1>
            </div>
            ...
            <p>
                <a href="${pageContext.request.contextPath}/scene/createBelow?id=${viewModel.id}" role="button" class="secondary" role="button">Create New Scene</a>
                <a href="${pageContext.request.contextPath}/character/create?projectId=${viewModel.projectId}" role="button" class="secondary" role="button">Create New Character</a>
            </p>
            <nav aria-label="...">
                <ul class="pager">
